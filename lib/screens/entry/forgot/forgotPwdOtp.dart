...
class ForgotPwdOtp extends StatefulWidget {
  @override
  _ForgotPwdOtpState createState() => _ForgotPwdOtpState();
}

class _ForgotPwdOtpState extends State<ForgotPwdOtp> with TickerProviderStateMixin{
    var onTapRecognizer;
  ...
  Widget build(BuildContext context) {
   ...
   String i=ModalRoute.of(context).settings.arguments;
    textEditingController.text="1526";//0 is for ForgotPwdOtp
    var child = Container(
          ...
          // SizedBox(height:Short.h*0.1),
           Padding(
             ...
             child: Column(
                ...
                children: <Widget>[
                  Text(
                    "One time password(ForgotPwdOtp) has been ",
                    style: TextStyle(
           ...
           Padding(
            ...
            Padding(
                          ...
                          child: RaisedButton(
                              ...
                              color: Theme.of(context).primaryColor,
                              onPressed: () {
                                print("Verify ForgotPwdOtp button is clicked");
                              ...
                              child: Text("VERIFY ForgotPwdOtp",
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 22))),
                        ),
